...
- 431 юнит-тест; живые прогоны: панели 140, пусковой комплекс 41, каталог 10,
  лента 16, язык 10, движки агентов 21, модели распознавания 16 + 22, разбор
  клавиш 6, проекты 6.
- Шесть прогонов на живом приложении идут в CI под xvfb на каждый push — к ним
  добавились своя модель распознавания и разбор клавиш.
