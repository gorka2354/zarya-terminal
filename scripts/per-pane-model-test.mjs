/**
 * Модель — у каждой панели своя, и автопилот означает одно и то же у всех движков.
 *
 ...
 *    OPUS.
 *
 * 2. Автопилот у Codex означал не то же, что у Claude Code: он не спрашивал
 *    вовсе, тогда как второй показывал необратимое даже при снятых гейтах.
 *    Подпись чипа при этом одна на все движки. С 2026-09-04 разночтения нет с
 *    другой стороны: не спрашивают нигде — см. `scripts/gate-floor-test.mjs`.
 */
