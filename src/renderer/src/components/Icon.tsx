...
const PATHS: Record<IconName, React.ReactNode> = {
  ...
  /*
   * Восход — фирменный знак вместо ракеты.
   *
   * Диск наполовину над линией горизонта, три луча. Ракета была самой прямой
   * цитатой из космической эпохи; солнце над горизонтом говорит то же самое
   * («начали»), но словом самого имени — «Заря».
   */
  rocket: (
    <>
      <path d="M3.5 16.5h17" />
      <path d="M6.8 16.5a5.2 5.2 0 0 1 10.4 0" />
      <path d="M12 3.6v2.4M4.9 6.4l1.7 1.7M19.1 6.4l-1.7 1.7" />
      <path d="M5 20h4M11 20h3M16 20h3" />
    </>
  ),
  satellite: (
    <>
