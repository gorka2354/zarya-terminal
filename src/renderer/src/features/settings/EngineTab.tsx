 ...
 *
 * ВЫКЛЮЧЕНО ПО УМОЛЧАНИЮ, и подпись говорит почему: это доступ агента к
 * соседним панелям, и включать его человек должен сам. Про цену подпись теперь
 * говорит по факту — имена инструментов лежат всегда, описания движок держит
 * наготове и подгружает по надобности (замер inc-47).
 *
