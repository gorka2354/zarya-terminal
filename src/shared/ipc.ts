...
export const CH = {
  ...
  /**
   * Человек щёлкнул по уведомлению — показать ту панель, о которой звали.
   *
   * Раньше клик только поднимал окно, и человек оказывался на том столе, где
   * был: ждущая панель могла быть на соседнем, и он искал её глазами. Зов,
