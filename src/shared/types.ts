...
export interface AiSettings {
   ...
   *
   * ВЫКЛЮЧЕНО ПО УМОЛЧАНИЮ, и это не осторожность ради осторожности: два
   * инструмента живут в контексте КАЖДОГО запроса и стоят токенов — ровно то,
   * за что Заря считает цену скиллов. Тихо добавить себе платный сервер было бы
   * лицемерием.
   */
