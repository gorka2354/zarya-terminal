...
export interface VoiceSettings {
  ...
  deviceLabel: string
  /**
   * Какая модель распознавания выбрана (id из реестра). Пусто — модель по
   * умолчанию. Список закрытый и живёт в коде: настраиваемый источник был бы
   * способом скормить нативному движку произвольный файл.
   */
  modelId: string
}
